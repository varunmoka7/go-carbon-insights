...
-- Add new columns to support manual uploads (only if they don't exist)
ALTER TABLE community_categories ADD COLUMN IF NOT EXISTS created_by UUID REFERENCES community_users(id);
ALTER TABLE community_topics ADD COLUMN IF NOT EXISTS context_file TEXT;
