      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16">
        <div className="text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link to="/tracking">
              <Button variant="outline" size="lg" className="border-teal-600 text-teal-600 hover:bg-teal-50 px-8 py-3 group">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          {scopeIntro.map((scope, index) => (
            <Card key={index} className={`group hover:shadow-xl transition-all duration-300 border-l-4 border-l-current ${scope.color}`}>
              <CardHeader>
              ...
              <CardContent>
                ...
                <div className="space-y-2">
                  <h4 className="font-semibold text-sm text-gray-900">Examples:</h4>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <Link key={index} to={feature.href} className="group">
              <Card className="h-full bg-white rounded-xl shadow-sm border border-gray-200 p-8 hover:shadow-lg transition-all duration-300 hover:scale-105">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-4 group-hover:text-teal-600 transition-colors">
                  {feature.title}
                </h3>
