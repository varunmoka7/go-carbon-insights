    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-green-25">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <div className="flex flex-col lg:flex-row gap-6 mb-8">
            <div className="flex items-center space-x-3">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-10 w-64 h-10 bg-white border-green-200 focus:border-green-500"
                />
              </div>
              <Select value={selectedCompany} onValueChange={setSelectedCompany}>
                <SelectTrigger className="w-64 h-10 bg-white border-green-200 focus:border-green-500">
                  <SelectValue />
                </SelectTrigger>
            ...
            <div className="flex items-center space-x-6">
              <div className="flex items-center space-x-3">
                ...
                <div className="w-40 px-4 py-2 bg-gradient-to-r from-green-50 to-white border border-green-200 rounded-md text-sm font-medium text-gray-700">
                  {company.industry}
                </div>
              </div>
              <div className="flex items-center space-x-3">
                <label className="text-sm font-semibold text-gray-800 min-w-fit">Sector:</label>
                <div className="w-48 px-4 py-2 bg-gradient-to-r from-green-50 to-white border border-green-200 rounded-md text-sm font-medium text-gray-700">
                  {company.sector}
                </div>
              </div>
            </div>
          ...
          <div className="bg-gradient-to-br from-white to-green-50 rounded-xl shadow-lg border border-green-100 p-8 mb-8">
                ...
                <div className="bg-gradient-to-br from-green-50 to-white rounded-lg p-6 border border-green-200">
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between items-center text-sm">
                      ...
                      <span className="font-semibold text-green-700">{company.sbtiTargets.nearTermTarget}</span>
                    </div>
                    <div className="flex justify-between items-center text-sm">
                      <span className="text-gray-600 font-medium">Long-term Target:</span>
                      <span className="font-semibold text-green-700">{company.sbtiTargets.longTermTarget}</span>
                    </div>
                    <div className="flex justify-between items-center text-sm">
                      <span className="text-gray-600 font-medium">Baseline Year:</span>
                      <span className="font-semibold text-green-700">{company.sbtiTargets.baselineYear}</span>
                    </div>
                    {company.sbtiProgress && (
                      <div className="mt-4">
                        <div className="flex justify-between items-center text-sm mb-2">
                          <span className="text-gray-600 font-medium">Progress:</span>
                          <span className="font-semibold text-green-700">{company.sbtiProgress}%</span>
                        </div>
                        <div className="w-full bg-gray-200 rounded-full h-2">
                          <div 
                            className="bg-gradient-to-r from-green-500 to-green-600 h-2 rounded-full transition-all duration-300" 
                            style={{ width: `${company.sbtiProgress}%` }}
                          ></div>
                        </div>
                      </div>
                    )}
          ...
          <div className="flex justify-between items-center mb-6">
            ...
            <div className="flex items-center space-x-3">
              ...
              <Select value={selectedScope} onValueChange={setSelectedScope}>
                <SelectTrigger className="w-56 h-10 bg-white border-green-200 focus:border-green-500">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
        ...
        <div className="mt-8 grid lg:grid-cols-2 gap-8">
          <div className="bg-gradient-to-br from-white to-green-50 rounded-xl shadow-lg border border-green-100 p-8">
