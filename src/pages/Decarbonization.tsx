...
import { ArrowLeft, AlertTriangle, Target, TrendingDown, Leaf, Building, Users, BarChart3 } from 'lucide-react';
...
const Decarbonization = () => {
  ...
  // Get companies from all sectors for comparison (not just same sector)
  ...
  const sectorData = [
    ...
    { name: 'Manufacturing', progress: 60 },
    { name: 'Energy', progress: 45 },
    { name: 'Retail', progress: 55 },
    { name: 'Finance', progress: 80 }
  ];
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription className="text-gray-600">
                Industry-wide decarbonization progress and benchmarking
              </CardDescription>
            </div>
          </div>
      ...
      {/* Carbon Strategy Section - Enhanced with detailed content */}
      <Card className="mb-8">
        <CardHeader>
              ...
              <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-lg p-6">
                ...
                <div className="space-y-3">
                  <div className="flex justify-between">
                    ...
                    <span className="font-bold text-lg">{(company.totalEmissions / 1000).toFixed(1)}M tCO2e</span>
                  </div>
                  <div className="flex justify-between">
