...
export class SustainabilityExpertAgent extends BaseAgent {
  constructor() {
    const config: AgentConfig = {
      maxTokens: 800,
      temperature: 0.4,
      systemPrompt: 'You are a sustainability expert with deep knowledge of environmental science, corporate sustainability, and climate action.',
      fallbackResponses: [
    ...
    super(
      'sustainability-expert-001',
      'Dr. Green',
      AgentPersona.SUSTAINABILITY_EXPERT,
      'Expert in sustainability practices, environmental science, and corporate climate strategies',
      [
